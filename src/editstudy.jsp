...
<section id="newstudy_form">
    <form action="StudyController?action=update&AMP;StudyCode=${studyRecord.studyCode}" method="post">
        <label>Study Name *</label>
        <input type="text" name="study_name" value="${requestScope.studyRecord.studyName}" required /><br>
        <label>Question Text *</label>
        <input type="text" name="question_text" value="${requestScope.studyRecord.question}" required/><br>
        ...
        <input type="text" name="participants" value="${requestScope.studyRecord.numOfParticipants}" required/><br>
        ...
        <textarea name="description"  required>${requestScope.studyRecord.description}</textarea><br>
